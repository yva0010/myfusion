...
from myfusion import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, wording
from myfusion.face_analyser import get_many_faces, get_one_face
from myfusion.face_helper import warp_face_by_face_landmark_5
...
from myfusion.filesystem import in_directory, same_file_extension
from myfusion.processors import choices as processors_choices
from myfusion.processors.typing import FaceDebuggerInputs
from myfusion.program_helper import find_argument_group
from myfusion.typing import ApplyStateItem, Args, Face, InferencePool, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		myfusion.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
