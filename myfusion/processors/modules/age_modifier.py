...
from myfusion.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from myfusion.processors.typing import AgeModifierDirection, AgeModifierInputs
from myfusion.program_helper import find_argument_group
from myfusion.thread_helper import thread_semaphore
...
from myfusion.vision import match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		myfusion.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if has_execution_provider('coreml'):
		age_modifier.set_providers([ myfusion.choices.execution_provider_set.get('cpu') ])
