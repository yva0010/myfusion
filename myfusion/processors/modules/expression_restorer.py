...
from myfusion.common_helper import create_int_metavar
from myfusion.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from myfusion.face_analyser import get_many_faces, get_one_face
from myfusion.face_helper import paste_back, warp_face_by_face_landmark_5
from myfusion.face_masker import create_occlusion_mask, create_static_box_mask
from myfusion.face_selector import find_similar_faces, sort_and_filter_faces
from myfusion.face_store import get_reference_faces
from myfusion.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from myfusion.processors import choices as processors_choices
from myfusion.processors.live_portrait import create_rotation, limit_expression
from myfusion.processors.typing import ExpressionRestorerInputs
from myfusion.processors.typing import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from myfusion.program_helper import find_argument_group
from myfusion.thread_helper import conditional_thread_semaphore, thread_semaphore
from myfusion.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from myfusion.vision import get_video_frame, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		myfusion.jobs.job_store.register_step_keys([ 'expression_restorer_model','expression_restorer_factor' ])
