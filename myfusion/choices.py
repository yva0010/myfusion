...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/myfusion/myfusion-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'url': 'https://huggingface.co',
		'path': '/myfusion/{base_name}/resolve/main/{file_name}'
	}
}
