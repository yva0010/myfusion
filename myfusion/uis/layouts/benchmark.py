...
from myfusion.download import conditional_download, resolve_download_url
from myfusion.uis.components import about, age_modifier_options, benchmark, benchmark_options, deep_swapper_options, download, execution, execution_queue_count, execution_thread_count, expression_restorer_options, face_debugger_options, face_editor_options, face_enhancer_options, face_swapper_options, frame_colorizer_options, frame_enhancer_options, lip_syncer_options, memory, processors
...
def run(ui : gradio.Blocks) -> None:
	ui.launch(favicon_path = 'myfusion.ico', inbrowser = state_manager.get_item('open_browser'))
