...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(myfusion.choices.execution_thread_count_range),
		minimum = myfusion.choices.execution_thread_count_range[0],
		maximum = myfusion.choices.execution_thread_count_range[-1]
	)
